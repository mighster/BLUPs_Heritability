...
#Import new df
df<-read.csv("C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/Data/BlueSteelData_Sept25_thinned.csv")
...
Day6DataOutput <- data.frame(matrix(vector(),300,1, dimnames=list(c(), c("Name"))))

#fill empty dataframe with 1-300 so that the cbind will work later on
Day6DataOutput$Row <- c(1:300)
...
#output that beast
write.csv(Day6DataOutput,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPsDay6_thinned_Oct19.csv")
write.csv(Day6VarCompOutput,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/VarianceComponents_thinned_Oct19.csv")
    

######################################## Day 9 ############################################

#Create empty data frame for BLUP output
Day9DataOutput <- data.frame(matrix(vector(),300,1, dimnames=list(c(), c("Name"))))

#fill empty dataframe with 1-300 so that the cbind will work later on
Day9DataOutput$Row <- c(1:300)
Day9DataOutput$Day <- c(6)
...
#output that beast
write.csv(Day9DataOutput,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPs/BLUPsDay9_thinned_Oct19.csv")
write.csv(Day9VarCompOutput,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPs/VarianceComponents_thinned_Oct19.csv")

######################################## Day 12 ############################################


#Create empty data frame for BLUP output
Day12DataOutput <- data.frame(matrix(vector(),300,1, dimnames=list(c(), c("Name"))))

#fill empty dataframe with 1-300 so that the cbind will work later on
Day12DataOutput$Row <- c(1:300)
Day12DataOutput$Day <- c(6)
...
#output that beast
write.csv(Day12DataOutput,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPs/BLUPsDay12_thinned_Oct19.csv")
write.csv(Day12VarCompOutput,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPs/VarianceComponents_thinned_Oct19.csv")
#################################################################################################
...
write.csv(VarCompOutputAllDays,"C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPs/VarCompOutputAllDays_thinned.csv")

rm(DataOutputAllDays)
DataOutputAllDays <- rbind(Day6DataOutput,Day9DataOutput,Day12DataOutput)
write.csv(DataOutputAllDays, "C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/BLUPs/AdjustedBLUPsAllDays_thinned.csv")
